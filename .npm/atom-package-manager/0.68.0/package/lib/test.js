(function() {
  ...
  module.exports = Test = (function(_super) {
    ...
    Test.prototype.run = function(options) {
      var args, atomCommand, callback, cmd, cmdArgs, cmdOptions, env, logFile, logFilePath, packagePath, testArgs, _ref;
      ...
      if (process.platform === 'win32') {
        ...
        cmdArgs = testArgs.map(function(arg) {
        ...
        return this.spawn(cmd, cmdArgs, cmdOptions, function(code) {
          var loggedOutput;
          try {
