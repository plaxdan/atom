(function() {
  ...
  module.exports = Publish = (function(_super) {
    ...
    Publish.prototype.versionPackage = function(version, callback) {
      ...
      return this.fork(this.atomNpmPath, versionArgs, function(code, stderr, stdout) {
        if (stderr == null) {
          stderr = '';
        }
        if (stdout == null) {
    ...
    Publish.prototype.pushVersion = function(tag, callback) {
      ...
      return this.spawn('git', pushArgs, function(code, stderr, stdout) {
        if (stderr == null) {
          stderr = '';
        }
        if (stdout == null) {
    ...
    Publish.prototype.publishPackage = function(pack, tag, callback) {
      ...
      return this.createPackageVersion(pack.name, tag, function(error) {
        if (error != null) {
          process.stdout.write('\u2717\n'.red);
          return callback(error);
        } else {
    ...
    Publish.prototype.loadRepository = function() {
      ...
      if ((repo != null ? repo.getWorkingDirectory().toLowerCase() : void 0) !== currentDirectory.toLowerCase()) {
