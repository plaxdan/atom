...
__S4 System__ | __Planner__ | __Crew Lead__
----------|----------|----------
The S4 system is an external GIS application which is used to create PM work orders in Maximo. | The Planner is responsible for assigning Crew Leads to PM Work Orders. | The Crew Lead works with one colleague and a truck to clean out the pipes in a given basin.
