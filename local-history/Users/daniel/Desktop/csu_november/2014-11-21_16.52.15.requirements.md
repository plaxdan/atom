...
1. Supervisor
Followup (grandchild) work orders are created in the field by Crew Leads and assigned to Supervisors. Supervisors manage the followup work orders in Maximo.
