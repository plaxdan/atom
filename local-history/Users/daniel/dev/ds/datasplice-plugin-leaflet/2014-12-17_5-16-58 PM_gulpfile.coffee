...
paths =
  ...
  dist:     "#{projectPath}/dist/Server/Resources/WebClient/#{pkg.name}"
...
webpackConfig.devtool = 'sourcemap' if $.util.env.sourcemap
webpackConfig.plugins.push new webpack.DefinePlugin
  TRACE: $.util.env.trace and not $.util.env.production
  DEBUG: not $.util.env.production
unless $.util.env.nouglify or $.util.env.production
