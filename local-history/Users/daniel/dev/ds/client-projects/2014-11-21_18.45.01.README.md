...
1. Enter water and fuel usage for the day
1. View child work orders
1. Mark a child work order as done (status `NEW` > `COMP`)
1. Wen the last child work order is finished then the parent work order should automatically be set to `COMP`

#### Map
1. View subbasin for PM on map
1. View pipe for child work order on map
1. Pipe segments should reflect the status of the child work order they're associated with
