...
1. created using DataSplice by a Crew Lead in the field
  1. populated with fields from a master work order (WONUM 2676660)
  1. work type is "EM "
1. assigned to Supervisor users
1. managed entirely within Maximo after their initial creation in DataSplice
