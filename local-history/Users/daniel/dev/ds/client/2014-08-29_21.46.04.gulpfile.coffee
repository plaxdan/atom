...
webpackConfig =
  cache: true
  entry:
    shared: "#{webBuildPath}/shared.coffee"
    index: "#{webBuildPath}/index.coffee"
    test: "#{webBuildPath}/test.coffee"
  output:
...
gulp.task 'build:js', ->
  gulp.src "#{srcPath}/grammar/parser.js"
...
gulp.task 'watch', [ 'build' ], (cb) ->
  ...
  gulp.watch "#{srcPath}/coffee/**/*.coffee", doReload 'build:webpack'
