...
vendorsBundlePath = "#{webBuildPath}/vendor"
globalVendorsFileName = 'vendors.bundle.js'
...
# - Vendors may have a dest or global=true but not both
# - Assets may have a dest or global=true but not both
...
gulp.task 'build:vendor', ->
  ...
  globalVendorsRelativeFilePath =
    "#{path.relative '.', vendorsBundlePath}/#{globalVendorsFileName}"
  ...
  if globalVendors.length > 0
    gulp.src globalVendors
      ...
      .pipe gulp.dest vendorsBundlePath
