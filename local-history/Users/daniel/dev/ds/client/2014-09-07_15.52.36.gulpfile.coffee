...
# - Vendors have a dest or global=true but not both
# - Vendor dest defaults to "#{webBuildPath}/vendor/#{vendor.name}"
# - Assets also have a dest or global=true but not both
# - If asset has no dest, vendor dest is inherited
# - If asset is a string, its src is relative to vendor.base
    ...
    for asset in vendor.assets
      ...
      if vendor.global or asset.global
        ...
        if vendor.shared
         ...
         asset.dest or= "#{vendor.dest}/#{asset.dest}"
