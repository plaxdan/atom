...
class ConnectionManager
  ...
  setSessionMode: (mode) ->
    ...
    modeSetter = switch mode
      when 'online' then @dataSpliceWebService.setOnlineSessionMode
      when 'offline' then @dataSpliceWebService.setOfflineSessionMode
        ...
        if wait
          wait
            .then =>
              @monitorConnection()
            .catch (message) =>
              @dataSpliceWebService.cancelSync()
  ...
  _startSync: ->
    ...
    @_generateOfflineDigest()
      .then (digest) =>
        @dataSpliceWebService.sync digest
  ...
  _generateOfflineDigest: ->
    ...
    @dataSpliceWebService.getRemoteDigests()
      .then (result) =>
