...
describe 'Promise Handling', ->
  ...
  it 'test behavior of catch', (done) ->
    rejects = new Promise (resolve, reject) ->
      console.log "FAIL"
      reject 'fail'
    throws = new Promise (resolve, reject) ->
      console.log "ERROR"
      throw new Error 'waa waa'
    ...
    Promise.resolve resolves
      .then throws
      .then rejects
      .catch (caught) -> console.log 'Caught', caught
