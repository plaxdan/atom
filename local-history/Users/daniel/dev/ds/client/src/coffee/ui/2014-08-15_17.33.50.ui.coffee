...
UI = React.createClass
  ...
  render: ->
    serverAndSession = @state.sessionLoaded and @state.serverLoaded
    serverNoSession = @state.serverLoaded and not @state.sessionLoaded
    div id: 'ui', className: 'page-container',
      ModalManager factory: @props.factory, pubSub: @props.factory.pubSub
      Header factory: @props.factory if serverAndSession
      Content factory: @props.factory if serverAndSession
      Login factory: @props.factory if serverNoSession
