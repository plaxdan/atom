...
{FluxAPI} = require './flux/constants'
Intents = require './flux/actions'
...
class DataSpliceApplication extends Backbone.Router
  ...
  whenThisBabyHits88mph: (factory) ->
    ...
    intents = (new Intents factory).intents()
    new Fluxxor.Flux stores, intents
