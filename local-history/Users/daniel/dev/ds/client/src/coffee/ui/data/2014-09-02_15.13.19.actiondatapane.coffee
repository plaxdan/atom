...
ActionDataPane = React.createClass
  ...
  _receiveProps: (props) ->
    ...
    nextReactState = {}
    nextReactState.actionPlugin = plugin
    ...
    if actionProps
      ...
      (Promise.resolve ExpressionEvaluator.evaluateAttributes actionProps,
        ...
        nextReactState.actionProps = actionsProps if @isMounted()
      .then ->
        @setState nextReactState
  ...
  render: ->
    ...
    if @state.actionPlugin
      ...
      @transferPropsTo plugin.createDisplayComponent @props.displayMode, paneProps
