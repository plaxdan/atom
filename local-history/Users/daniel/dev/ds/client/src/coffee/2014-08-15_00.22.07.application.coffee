...
class DataSpliceApplication extends Backbone.Router
  ...
  doSessionSelection: ->
    # TODO: call callback of UI component
    # @pubSub.trigger 'replaceView', @viewFactory.create SessionSelectionView
    @ui.setProps hasSession: false if @ui.isMounted()
  ...
  run: ->
    ...
    @ui = React.renderComponent (UI factory: @viewFactory), mountPoint
  ...
  sessionLoaded: =>
    @ui.setProps hasSession: true if @ui.isMounted()
