      ...
      switch @state.server.status
        ...
        when FluxMessages.SERVER_LOADED
          switch @state.session.status
            when FluxMessages.SESSION_ERROR or FluxMessages.SESSION_DESTROYED or FluxMessages.SESSION_LOADING
              @_renderLogin()
            when FluxMessages.SESSION_CREATED or FluxMessages.SESSION_RESUMED
