...
Login = React.createClass
  ...
  propTypes:
    loginHandler: React.PropTypes.func.required
    aboutHandler: React.PropTypes.func.required
    loginBanner: React.PropTypes.string.required
    buildVersion: React.PropTypes.string.required
    instanceName: React.PropTypes.string.required
    authDomains: React.PropTypes.array.required
    defaultAuthDomain: React.PropTypes.string.required
