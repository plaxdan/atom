...
module.exports =  (factory) ->
  ...
  appCacheService = new AppCacheService
  ...
  sessionService = new SessionService factory, modificationService
  # In the future we can swap this out for another non-jquery service with
  # the same interface.
  httpService = new JQueryHTTPService
