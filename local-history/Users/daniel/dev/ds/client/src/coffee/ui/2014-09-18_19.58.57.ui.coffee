...
UI = React.createClass
  ...
  getStateFromFlux: ->
    serverStoreState = (@getFlux().store Stores.Server).state
    {
      serverLoading: serverStoreState.serverLoading
      serverLoaded: serverStoreState.serverLoaded
      authDomains: serverStoreState.authDomains
      buildVersion: serverStoreState.buildVersion
      defaultAuthDomain: serverStoreState.defaultAuthDomain
      instanceName: serverStoreState.instanceName
    }
