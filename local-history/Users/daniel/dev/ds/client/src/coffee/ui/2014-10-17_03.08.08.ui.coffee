      ...
      switch @state.server.status
        ...
        when FluxMessages.SERVER_LOADED
          switch @state.session.status
            when FluxMessages.SESSION_ERROR or FluxMessages.SESSION_DESTROYED then
              @_renderLogin()
            when FluxMessages.SESSION_CREATED or FluxMessages.SESSION_RESUMED then
              @_renderComponent route
            when FluxMessages.SESSION_LOADING then
              # TODO: spinner or what not
            else
              # TODO: BORK
