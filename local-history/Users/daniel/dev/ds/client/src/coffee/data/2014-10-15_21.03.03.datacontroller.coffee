...
class DataController
  ...
  constructor: (@factory) ->
    ...
    # TODO externalize the logic for determining which storage adapter the
    # datacontroller gets. Some sort of StorageStrategy object.
    ...
    @factory.pubSub.on
      ...
      # TODO: move this into a DataService class which is then used within the
      # SessionService.

      # listen to view change events once the session has loaded
      sessionLoaded: =>
        console.warn "DATA CONTROLLER SESSIONLOADED"
