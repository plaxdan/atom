...
DataSpliceWebService = require './services/datasplicewebservice'
HardwareService = require './services/hardwareservice'
...
class DataSpliceApplication extends Backbone.Router
  ...
  whenThisBabyHits88mph: (factory, services) ->
    stores = {}
    ...
    actions = new Actions factory, services
