...
class DataSpliceApplication extends Backbone.Router
  ...
  constructor: ->
    ...
    dataSpliceWebService = new DataSpliceWebService

    @appController = new DataSpliceController @pubSub, @viewFactory, dataSpliceWebService
    @connectionManager = new ConnectionManager @viewFactory, dataSpliceWebService
