...
class DataSpliceController
  ...
  constructor: (@pubSub, @factory, @dataSpliceWebService) ->
  ...
  initializeFactory: ->
    ...
    @eventFactory = new EventFactory @factory, @dataSpliceWebService
    ...
    @pluginRegistry = new PluginRegistry @factory, @dataSpliceWebService
      ...
      ef.execute EventRegistry.LogOut, ef.context(), (context) =>
        ...
        ($.when @factory.modificationHandler.commitChanges())
          .done =>
            ...
            @dataSpliceWebService.destroySession()
              .then afterDestroySession
              .catch ->
                afterDestroySession()
