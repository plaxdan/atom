...
Header = React.createClass
  ...
  getStateFromFlux: ->
    ...
    #
    sessionStoreData: @getFlux().store('SessionStore').getState()
  ...
  render: ->
    ...
    div null,
      AppMenu
        ...
        userName: @state.sessionStoreData.userName
      ...
      if @state.messageCenterSection
        MessageCenter
          sessionMode: @state.sessionStoreData.sessionMode
          userIdentifier: @state.sessionStoreData.userIdentifier
