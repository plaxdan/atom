...
UI = React.createClass
  ...
  componentWillReceiveProps: (nextProps) ->
    console.info "UI: componentWillReceiveProps #{nextProps}"
    @setState: contentView: nextProps.contentView

  render: ->
    console.info "Rendering UI with state: #{JSON.stringify @state}"
    app = [
      Header factory: @props.factory
      Content factory: @props.factory, contentView: @state.contentView
    ]
