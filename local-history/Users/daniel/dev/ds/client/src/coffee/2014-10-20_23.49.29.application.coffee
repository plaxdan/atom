...
class DataSpliceApplication extends Backbone.Router
  ...
  constructor: ->
    ...
    @services = (require './services') @viewFactory
<<<<<<< HEAD
...
<<<<<<< HEAD
    ...
    @viewFactory.register 'hardwareService', hardwareService

    @flux = @whenThisBabyHits88mph @services, @viewFactory
    @viewFactory.register 'flux', @flux

    @appController = new DataSpliceController @pubSub, @viewFactory, webService
    @connectionManager = new ConnectionManager @viewFactory, webService
=======
      hardwareService
      sessionService
      webService
    ...
    @appController = new DataSpliceController @pubSub, sessionService, webService, @viewFactory
    @connectionManager = new ConnectionManager webService, @viewFactory
>>>>>>> exports services as one layer

    @viewFactory.register 'appController', @appContrviewFactory
    ...
    # and automatically refresh the page if that is theviewFaViewFaViewFactory
...
>>>>>>> exports services as one layer
  ...
  whenThisBabyHits88mph: (services, factory) ->
    stores = {}
...
<<<<<<< HEAD
    ...
    actions = Actions services, factory
=======
    actions = new Actions services, factory
>>>>>>> exports services as one layer
  ...
  getLocale: ->
    (@viewFactory.session.get 'attributes')?['DS_LOCALE'] or
      (@viewFactory.server.get 'acceptLanguage') or
      'en'
