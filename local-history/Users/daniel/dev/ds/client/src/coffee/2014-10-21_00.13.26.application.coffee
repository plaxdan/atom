...
<<<<<<< HEAD
    ...
    @appController = new DataSpliceController @pubSub, @flux.actions, webService, @viewFactory
    @connectionManager = new ConnectionManager @flux.actions, webService, @viewFactory
=======
      webService
      hardwareService
    } = @services
