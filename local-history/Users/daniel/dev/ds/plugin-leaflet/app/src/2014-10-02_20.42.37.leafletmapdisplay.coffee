module.exports = (dsApp) ->
  ...
  LeafletMapDisplay = React.createClass
    ...
    render: ->
      return div null unless @props.actionProps.settings?
      ...
      center = (activeState.get 'center') or @props.actionProps.settings.initialCenter
      zoom = (activeState.get 'zoom') or @props.actionProps.settings.initialZoom

      LeafletMap _.extend {}, @props.actionProps.settings,
        ref: 'leafletMap'
        layers: @state?.layers
    ...
    selectCoordinates: (latlng) ->
      ...
      # coordinates
      if @props.actionProps.settings.selection
        @_applySelection
          type: 'latlng'
          latlng: latlng
          options: @props.actionProps.settings.selection
    ...
    _fetchMapLayers: ->
      return unless @props.actionProps.settings?
      ...
      layers = {}
      map =
        geoJson: @props.actionProps.settings.layers
        data: @props.actionProps.settings.dataLayers
