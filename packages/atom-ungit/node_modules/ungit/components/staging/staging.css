...
.staging .arrowDown .arrow {
  background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB4AAAAPAQMAAADJdO3fAAAABlBMVEUAAABkOkS+oYHDAAAAAXRSTlMAQObYZgAAADpJREFUCB0FwUsRgDAQBbDwagxpSFspldBjZ/gsydG8w+lOsTNZWcxsyuiWT0v7xPWI2mIusabYhcEP360Y7Jh2Pp0AAAAASUVORK5CYII=);
}
.staging .file-area {
  position: relative;
}
